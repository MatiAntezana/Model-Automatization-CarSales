...
class RandomForestModel:
    """Random Forest regressor wrapper with preprocessing and evaluation metrics."""

    def __init__(self, n_estimators, random_state) -> None:
        """Initialize model hyperparameters and metric placeholders."""
...
def create_model(model_config):
    """Factory function used by the pipeline to instantiate the random forest model."""
    return RandomForestModel(n_estimators=model_config.n_estimators, random_state=model_config.random_state)
